...
if __name__ == '__main__':
    ...
    run_bin_classifier("Bug", cfgs, "_merged")
    run_bin_classifier("Feature", cfgs, "_merged")
    run_bin_classifier("UserExperience", cfgs, "_merged")
    run_bin_classifier("Rating", cfgs, "_merged")
